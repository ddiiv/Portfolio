        ...
        <div className="ticket-row--conteiner">
          <div className="columns-presentation">
            <div className="ticket-right-column">
              <h5 className="ticket-row__right-column--primary-text">
                <span className="richtext textname">
                  {" "}
            ...
            <div className="ticket-row--download_CV">
              <div className="handlers-switch">
                <h5 className="ticket-row__left-column--primary-text">
                  <span className="richtext description">
                    {(cvstate == true && "Estas viendo el CV en Español") ||
                      (cvstate == false &&
                        "You are viewing this CV in English")}{" "}
                  </span>
                </h5>
